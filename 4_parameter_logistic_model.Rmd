...
```{r badaplot, warning=FALSE, message=FALSE, fig.height=20, fig.width=12}
...
```{r bada4pl, warning=FALSE, message=FALSE, cache=TRUE}
# get starting values
...
```{r sshplot, warning=FALSE, message=FALSE, fig.height=20, fig.width=12}
...
```{r ssh4pl, message=FALSE, warning=FALSE, cache=TRUE}
# get starting values
...
```{r plotall, warning=FALSE, message=FALSE}
...
```{r 4plall, warning=FALSE, message=FALSE, cache=TRUE}
